 ...
 * @license MIT
 */var n=(t="",e="")=>{let i=Math.random().toString(36).substring(2,8);return`${"string"==typeof t&&""!==t?t+"-":""}${i}${"string"==typeof e&&""!==e?"-"+e:""}`},a=(t,e)=>{if(Object.prototype.hasOwnProperty.call(e,t)){let i=e[t];delete e[t],e[t]=i}},l=0,d=`
  :host {
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function I(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}q.innerHTML=`
  <style>
    ${B}
  </style>
 ...
 */var $=document.createElement("template");$.innerHTML=`
  ...
  <slot></slot>
`,(class t extends HTMLElement{#t=null;#b=null;#e=[];constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild($.content.cloneNode(!0)),this.#t=this.shadowRoot?.querySelector("slot")??null}static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,i){"disabled"===t&&e!==i&&(this.disabled?this.#s():this.#o())}connectedCallback(){this.#u("disabled"),"ResizeObserver"in window&&(this.#b=new ResizeObserver(t=>{this.dispatchEvent(new CustomEvent("resize-observer:resize",{bubbles:!0,composed:!0,detail:{entries:t}}))}),this.disabled||this.#o(),this.#t?.addEventListener("slotchange",this.#r))}disconnectedCallback(){this.#s(),this.#t?.removeEventListener("slotchange",this.#r)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}#o(){this.#t&&this.#b&&(this.#e.forEach(t=>this.#b?.unobserve(t)),this.#e=[],this.#t.assignedElements().forEach(t=>{this.#b?.observe(t),this.#e.push(t)}))}#s(){this.#b?.disconnect()}#r=()=>{this.disabled||this.#o()};#u(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e="resize-observer"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();/*!
...
`;var P=class t extends HTMLElement{#y={};#b=null;#c=null;#E=null;#t=null;#i=null;#o=null;#r=null;#e=null;constructor(){super(),this.#y=this.getSupportedConstraints(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(H.content.cloneNode(!0))}static get observedAttributes(){return["no-image","facing-mode","camera-resolution","pan","tilt","zoom","torch"]}attributeChangedCallback(t,e,i){if(!this.isConnected)return;let o=this.getTrackCapabilities(),s=this.getTrackSettings();if("no-image"===t&&e!==i&&this.#n(),"facing-mode"===t&&e!==i&&"facingMode"in this.#y){let t=["user","environment"].includes(this.facingMode||"");"facingMode"in s&&t&&this.#w()}if("camera-resolution"===t&&e!==i&&"string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,e=0]=this.cameraResolution.split("x").map(t=>Number(t));if(t>0&&e>0&&"width"in o&&"height"in o){let i=!!(o.width?.min&&o.width?.max)&&t>=o?.width?.min&&t<=o?.width?.max,r=!!(o.height?.min&&o.height?.max)&&e>=o?.height?.min&&e<=o?.height?.max;"width"in s&&"height"in s&&i&&r&&this.#w()}}if("pan"===t&&e!==i&&"pan"in this.#y){let t=!!("pan"in o&&o.pan?.min&&o.pan?.max)&&this.pan>=o.pan.min&&this.pan<=o.pan.max;"number"==typeof this.pan&&t&&this.#h("pan",this.pan)}if("tilt"===t&&e!==i&&"tilt"in this.#y){let t=!!("tilt"in o&&o.tilt?.min&&o.tilt?.max)&&this.tilt>=o.tilt.min&&this.tilt<=o.tilt.max;"number"==typeof this.tilt&&t&&this.#h("tilt",this.tilt)}if("zoom"===t&&e!==i&&"zoom"in this.#y){let t=!!("zoom"in o&&o.zoom?.min&&o.zoom?.max)&&this.zoom>=o.zoom.min&&this.zoom<=o.zoom.max;"number"==typeof this.zoom&&t&&this.#h("zoom",this.zoom)}"torch"===t&&e!==i&&"torch"in this.#y&&this.#h("torch",this.torch)}connectedCallback(){if(this.#s("autpoPlay"),this.#s("noImage"),this.#s("facingMode"),this.#s("cameraResolution"),this.#s("pan"),this.#s("tilt"),this.#s("zoom"),this.#s("torch"),this.#s("calculateFileSize"),this.#c=this.shadowRoot?.querySelector("canvas")||null,this.#E=this.shadowRoot?.getElementById("output")||null,this.#t=this.shadowRoot?.querySelector("video")||null,this.#i=this.shadowRoot?.querySelector('slot[name="capture-button"]')||null,this.#o=this.#p(),this.#r=this.shadowRoot?.querySelector('slot[name="facing-mode-button"]')||null,this.#e=this.#f(),this.#t?.addEventListener("loadedmetadata",this.#d),this.#i?.addEventListener("slotchange",this.#a),this.#o?.addEventListener("click",this.#u),this.#r?.addEventListener("slotchange",this.#l),this.#e?.addEventListener("click",this.#T),!t.isSupported())return this.dispatchEvent(new CustomEvent(`${D}:error`,{bubbles:!0,composed:!0,detail:{error:{name:"NotSupportedError",message:"Not supported"}}}));this.autoPlay&&this.startVideoStream()}disconnectedCallback(){this.stopVideoStream(),this.#e?.removeEventListener("click",this.#T),this.#o?.removeEventListener("click",this.#u),this.#t?.removeEventListener("canplay",this.#d),this.#i?.removeEventListener("slotchange",this.#a),this.#r?.removeEventListener("slotchange",this.#l)}get autoPlay(){return this.hasAttribute("auto-play")}set autoPlay(t){this.toggleAttribute("auto-play",!!t)}get noImage(){return this.hasAttribute("no-image")}set noImage(t){this.toggleAttribute("no-image",!!t)}get facingMode(){return this.getAttribute("facing-mode")||"user"}set facingMode(t){this.setAttribute("facing-mode",t)}get cameraResolution(){return this.getAttribute("camera-resolution")||""}set cameraResolution(t){this.setAttribute("camera-resolution",t)}get pan(){return Number(this.getAttribute("pan"))||0}set pan(t){this.setAttribute("pan",null!=t?t.toString():t)}get tilt(){return Number(this.getAttribute("tilt"))||0}set tilt(t){this.setAttribute("tilt",null!=t?t.toString():t)}get zoom(){return Number(this.getAttribute("zoom"))||1}set zoom(t){this.setAttribute("zoom",null!=t?t.toString():t)}get torch(){return this.hasAttribute("torch")}set torch(t){this.toggleAttribute("torch",!!t)}get loading(){return this.hasAttribute("loading")}get calculateFileSize(){return this.hasAttribute("calculate-file-size")}set calculateFileSize(t){this.toggleAttribute("calculate-file-size",!!t)}#T=t=>{t.preventDefault(),this.loading||(this.facingMode="user"!==this.facingMode&&this.facingMode?"user":"environment")};#u=t=>{t.preventDefault(),this.capture()};#d=t=>{let e=t.target;e.play().then(()=>{this.dispatchEvent(new CustomEvent(`${D}:video-play`,{bubbles:!0,composed:!0,detail:{video:e}}))}).catch(t=>{this.dispatchEvent(new CustomEvent(`${D}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}).finally(()=>{this.removeAttribute("loading")})};#n(){this.#E&&Array.from(this.#E.childNodes).forEach(t=>t.remove())}#h(t,e){if(!this.#b)return;let[i]=this.#b.getVideoTracks(),o=this.getTrackCapabilities(),s=this.getTrackSettings(),r="pan"===t||"tilt"===t||"zoom"===t?F(Number(e),o[t]?.min||1,o[t]?.max||1):e;t in s&&i.applyConstraints({advanced:[{[t]:r}]}).catch(()=>{})}#a=t=>{t.target?.name==="capture-button"&&(this.#o?.removeEventListener("click",this.#u),this.#o=this.#p(),this.#o&&(this.#o.addEventListener("click",this.#u),"BUTTON"===this.#o.nodeName||this.#o.hasAttribute("role")||this.#o.setAttribute("role","button")))};#l=t=>{t.target?.name==="facing-mode-button"&&(this.#e?.removeEventListener("click",this.#T),this.#e=this.#f(),this.#e&&(this.#e.addEventListener("click",this.#T),"BUTTON"===this.#e.nodeName||this.#e.hasAttribute("role")||this.#e.setAttribute("role","button")))};#f(){return this.#r&&this.#r.assignedElements({flatten:!0}).find(t=>"BUTTON"===t.nodeName||"facing-mode-button"===t.getAttribute("slot"))||null}#p(){return this.#i&&this.#i.assignedElements({flatten:!0}).find(t=>"BUTTON"===t.nodeName||"capture-button"===t.getAttribute("slot"))||null}#w(){this.stopVideoStream(),this.startVideoStream()}#s(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}async startVideoStream(){if(!t.isSupported()||this.#b)return;this.setAttribute("loading","");let e={video:{facingMode:{ideal:this.facingMode||"user"},pan:!0,tilt:!0,zoom:!0,torch:this.torch},audio:!1};if("string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,i=0]=this.cameraResolution.split("x").map(t=>Number(t));t>0&&i>0&&(e.video.width=t,e.video.height=i)}try{this.#b=await navigator.mediaDevices.getUserMedia(e),this.#t&&(this.#t.srcObject=this.#b),this.#h("pan",this.pan),this.#h("tilt",this.tilt),this.#h("zoom",this.zoom),"facingMode"in this.getTrackSettings()&&this.#r&&(this.#r.hidden=!1)}catch(t){this.dispatchEvent(new CustomEvent(`${D}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}finally{this.removeAttribute("loading")}}stopVideoStream(){if(!this.#t||!this.#b)return;let[t]=this.#b.getVideoTracks();t?.stop(),this.#t.srcObject=null,this.#b=null}async capture(){if(!(this.loading||!this.#c||!this.#t))try{let t=this.#c.getContext("2d"),e=this.#t.videoWidth,i=this.#t.videoHeight;this.#c.width=e,this.#c.height=i,t?.drawImage(this.#t,0,0,e,i);let o=this.#c.toDataURL("image/png");if("string"==typeof o&&o.includes("data:image")){if(!this.noImage){let t=new Image;t.src=o,t.width=e,t.height=i,t.alt="Captured photo",t.setAttribute("part","output-image"),this.#n(),this.#E?.appendChild(t)}let t={dataURI:o,width:e,height:i};if(this.calculateFileSize)try{let e=(await (await fetch(o)).blob()).size;e&&(t.size=e)}catch{}this.dispatchEvent(new CustomEvent(`${D}:success`,{bubbles:!0,composed:!0,detail:t}))}}catch(t){this.dispatchEvent(new CustomEvent(`${D}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}getSupportedConstraints(){return t.isSupported()&&navigator.mediaDevices.getSupportedConstraints()||{}}getTrackCapabilities(){if(!this.#b)return{};let[t]=this.#b.getVideoTracks();return t&&"function"==typeof t.getCapabilities&&t.getCapabilities()||{}}getTrackSettings(){if(!this.#b)return{};let[t]=this.#b.getVideoTracks();return t&&"function"==typeof t.getSettings&&t.getSettings()||{}}static isSupported(){return!!navigator.mediaDevices?.getUserMedia}static defineCustomElement(e=D){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}};let U="No barcode detected",V=["image/jpg","image/jpeg","image/png","image/apng","image/gif","image/webp","image/avif"];function W(t){return new Promise(function(e,i){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return i(t.error)}})}function G(){if(!t){var e,i,o,s;e="keyval-store",i="keyval",(o=indexedDB.open(e)).onupgradeneeded=function(){return o.result.createObjectStore(i)},s=W(o),t=function(t,e){return s.then(function(o){return e(o.transaction(i,t).objectStore(i))})}}return t}let Z="barcode-scanner/",Y="settings",Q="history",K=async t=>{try{return{value:await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:G();return e("readonly",function(e){return W(e.get(t))})}(t),error:void 0}}catch(t){return{value:void 0,error:t}}},X=async(t,e)=>{try{return await function(t,e){var i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:G();return i("readwrite",function(i){return i.put(e,t),W(i.transaction)})}(t,e),{error:void 0}}catch(t){return{error:t}}},J=async()=>K(Z+Y),tt=async t=>X(Z+Y,t),te=async()=>K(Z+Q),ti=async t=>X(Z+Q,t),to=(t,e=0,i=!1)=>{let o=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...s)=>{clearTimeout(o),i&&!o&&t(...s),o=setTimeout(()=>{o=null,i||t(...s)},e)}};function ts(t){let e=document.getElementById("historyList"),i=document.getElementById("emptyHistoryBtn");e.innerHTML="",Array.isArray(t)&&0!==t.length?(i.hidden=!1,t.forEach(t=>{let i;let o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(i=document.createElement("a")).href=t,i.setAttribute("target","_blank"),i.setAttribute("rel","noreferrer noopener")}catch{i=document.createElement("span")}i.textContent=t,i.setAttribute("title",t);let s=document.createElement("div");s.className="history-modal__actions";let r=document.createElement("custom-clipboard-copy");r.title="Copy to clipboard",r.setAttribute("only-icon",""),r.setAttribute("value",t),s.appendChild(r);let n=document.createElement("button");n.type="button",n.className="history-modal__delete-action",n.title="Remove from history",n.setAttribute("data-action","delete"),n.innerHTML=`
...
`;var tE=class t extends HTMLElement{#t=void 0;#b=null;#e=null;#o=null;#s=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tw.content.cloneNode(!0)),this.shadowRoot&&(this.#b=this.shadowRoot.querySelector("button"),this.#e=this.shadowRoot.querySelector('slot[name="copy"]'),this.#o=this.shadowRoot.querySelector('slot[name="success"]'),this.#s=this.shadowRoot.querySelector('slot[name="error"]'))}static get observedAttributes(){return["disabled"]}attributeChangedCallback(t,e,i){"disabled"===t&&e!==i&&this.#b&&(this.#b.disabled=this.disabled,this.#b.setAttribute("aria-disabled",this.disabled.toString()),this.#b.part.contains("button")&&this.#b.part.toggle("button--disabled",this.disabled))}connectedCallback(){this.#r("value"),this.#r("from"),this.#r("disabled"),this.#r("feedbackDuration"),this.#b?.addEventListener("click",this.#y)}disconnectedCallback(){this.#b?.removeEventListener("click",this.#y),this.#h()}get value(){return this.getAttribute("value")||""}set value(t){this.setAttribute("value",null!=t?t.toString():t)}get from(){return this.getAttribute("from")||""}set from(t){this.setAttribute("from",null!=t?t.toString():t)}get disabled(){return this.hasAttribute("disabled")}set disabled(t){this.toggleAttribute("disabled",!!t)}get feedbackDuration(){return Number(this.getAttribute("feedback-duration"))||1e3}set feedbackDuration(t){this.setAttribute("feedback-duration",null!=t?t.toString():t)}async #u(){if(!(!this.value&&!this.from))try{let t="";if(this.value)t=this.value;else if(this.from){let e="getRootNode"in Element.prototype?this.#b?.getRootNode({composed:!0}):this.#b?.ownerDocument;if(!e||!(e instanceof Document||e instanceof ShadowRoot))return;let i=e.querySelector(this.from);if(!i)return;i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?t=i.value:i instanceof HTMLAnchorElement&&i.hasAttribute("href")?t=i.href:t=i.textContent||""}await navigator.clipboard.writeText(t),this.#c(tf),this.dispatchEvent(new CustomEvent(`${tg}-success`,{bubbles:!0,composed:!0,detail:{value:t}}))}catch(t){this.#c(tv),this.dispatchEvent(new CustomEvent(`${tg}-error`,{bubbles:!0,composed:!0,detail:{error:t}}))}}#y=t=>{t.preventDefault(),this.disabled||this.#t||this.#u()};#c(t){this.#e&&(this.#e.hidden=!0),this.#o&&(this.#o.hidden=t!==tf),this.#s&&(this.#s.hidden=t!==tv),this.#b?.part.remove("button--success"),this.#b?.part.remove("button--error"),this.#b?.part.add(`button--${t}`),this.#t&&clearTimeout(this.#t),this.#t=setTimeout(()=>{this.#e&&(this.#e.hidden=!1),this.#o&&(this.#o.hidden=!0),this.#s&&(this.#s.hidden=!0),this.#b?.part.remove(`button--${t}`),this.#t=void 0},this.feedbackDuration)}#h(){this.#t&&clearTimeout(this.#t),this.#t=void 0,this.#e&&(this.#e.hidden=!1),this.#o&&(this.#o.hidden=!0),this.#s&&(this.#s.hidden=!0),this.#b?.part.remove("button--success"),this.#b?.part.remove("button--error")}#r(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=tg){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}};class tA extends tE{constructor(){super();let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]');t.innerHTML=`
      <svg xmlns="http://www.w3.org/2000/svg" width="1.125em" height="1.125em" fill="currentColor" viewBox="0 0 16 16">
    ...
    `}static get observedAttributes(){return[...super.observedAttributes,"only-icon"]}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),"only-icon"===t&&e!==i){let t=this.shadowRoot.querySelector('slot[name="copy"]'),e=this.shadowRoot.querySelector('slot[name="success"]'),i=t.querySelector(".text"),o=e.querySelector(".text");i&&(i.hidden=this.onlyIcon),o&&(o.hidden=this.onlyIcon)}}get onlyIcon(){return this.hasAttribute("only-icon")}set onlyIcon(t){t?this.setAttribute("only-icon",""):this.removeAttribute("only-icon")}connectedCallback(){super.connectedCallback(),this.#z("onlyIcon"),this.hasAttribute("feedback-duration")||this.setAttribute("feedback-duration","1500")}disconnectedCallback(){super.disconnectedCallback()}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="custom-clipboard-copy"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tA)}}tA.defineCustomElement(),async function(){let t;let e=document.querySelector("a-tab-group"),i=document.getElementById("cameraPanel"),o=document.querySelector("capture-photo"),s=document.getElementById("cameraResults"),r=document.getElementById("fileResults"),n=document.getElementById("scanInstructions"),a=document.getElementById("scanBtn"),l=document.getElementById("dropzone"),d=document.querySelector("resize-observer"),c=document.getElementById("scanFrame"),h=document.getElementById("torchButton"),u=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),m=document.getElementById("settingsBtn"),g=document.getElementById("settingsDialog"),f=document.forms["settings-form"],v=!0,{barcodeReader:w,barcodeFormats:y,barcodeReaderError:E}=await tp.init();if(E){let t=document.getElementById("barcodeReaderError");v=!1,u.hidden=!0,e.hidden=!0,t.hidden=!1,t.textContent=E?.message;return}o.addEventListener("capture-photo:video-play",function(t){c.hidden=!1,tu(t.detail.video,c),x();let e=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),s=document.getElementById("zoomLevel");if(i?.torch&&(h.hidden=!1,o.hasAttribute("torch")&&tm({el:h,isTorchOn:!0})),e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),r=i?.zoom?.min||0,n=i?.zoom?.max||10,a=e?.zoom||1;t.hidden=!1,s.textContent=a,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&a<n&&(a+=.5),i&&a>r&&(a-=.5),s.textContent=a,o.zoom=a})}},{once:!0}),o.addEventListener("capture-photo:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;i.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),P.defineCustomElement();let A=o?.shadowRoot?.querySelector("video");async function x(){n.hidden=!1;try{let e=await w.detect(A),i=e?.rawValue??"";if(!i)throw Error(U);window.cancelAnimationFrame(t),tl(i,s),tr(i),function(t){try{return new URL(t),!0}catch(t){return!1}}(i)?document.getElementById("openSEQRBrowserBtn").hidden=!1:document.getElementById("openSEQRBrowserBtn").hidden=!0,n.hidden=!0,a.hidden=!1,c.hidden=!0,th();return}catch{}}l.accept=V.join(","),tb(f),function(t){if(!Array.isArray(t)||0===t.length)return;let e=document.getElementById("supportedFormats");e&&(e.textContent=`Supported formats: ${t.join(", ")}`)}(y),ts((await te()).value||[]),I()||document.querySelectorAll("web-share").forEach(t=>{t.hidden=!0,t.disabled=!0}),document.getElementById("openSEQRBrowserBtn").addEventListener("click",function(){let t=document.getElementById("scannedResult").innerText;fetch(`/start_browser_session.sh?url=${encodeURIComponent(t)}`).then(t=>t.text()).then(t=>{let e=t.trim().split("\n").pop();window.location.href=e}).catch(t=>{console.error("Error occurred while starting SEQR session:",t)})}),v&&(t=window.requestAnimationFrame(()=>x())),a.addEventListener("click",function(){a.hidden=!0,c.hidden=!1,s&&(s.querySelector(".results__item")?.remove(),s.close()),x()}),e.addEventListener("a-tab-show",to(function(t){let e=t.detail.tabId,i=document.querySelector("capture-photo");switch(e){case"cameraTab":if(v=!0,!i)return;i.loading||s.querySelector(".results__item")||x(),"function"==typeof i.startVideoStream&&i.startVideoStream();break;case"fileTab":v=!1,null!=i&&"function"==typeof i.stopVideoStream&&i.stopVideoStream()}},250)),l.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,i=new FileReader;i.onload=i=>{let o=i.target.result;e.onload=async()=>{try{let t=await w.detect(e),i=t?.rawValue??"";if(!i)throw Error(U);tl(i,r),tr(i),th()}catch(t){tl(U,r)}},e.src=o,e.alt="Image preview",l.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let a=document.createElement("div");a.className="dropzone-preview__file-name",a.textContent=t.name,n.appendChild(e),s.appendChild(n),s.appendChild(a),l.prepend(s)},i.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),d.addEventListener("resize-observer:resize",function(){tu(o.shadowRoot.querySelector("video"),c)}),m.addEventListener("click",function(){g.showModal()}),g.addEventListener("click",function(t){t.target===t.currentTarget&&g.close()}),f.addEventListener("change",function(t){let e={};t.currentTarget.querySelectorAll('input[type="checkbox"]').forEach(t=>e[t.name]=t.checked),tt(e)}),p.addEventListener("click",function(){b.showModal()}),b.addEventListener("click",function(t){let e=t.target;if(e===t.currentTarget){b.close();return}if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;if(window.confirm(`Delete ${t}?`)){tn(t);return}}if(e.closest("#emptyHistoryBtn")&&window.confirm("Are you sure you want to empty history?")){ta();return}}),h.addEventListener("click",function(t){o.torch=!o.torch,tm({el:t.currentTarget,isTorchOn:o.hasAttribute("torch")})}),document.addEventListener("visibilitychange",function(){if("cameraTab"===e.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)v=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream();else{v=!0;let t=document.querySelector("capture-photo");if(!t)return;t.loading||s.querySelector(".results__item")||x(),"function"==typeof t.startVideoStream&&t.startVideoStream()}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=e.querySelector("#cameraTab").hasAttribute("selected"),i=!a.hidden,o=g.hasAttribute("open"),s=b.hasAttribute("open");i&&t&&!(o||s)&&a.click()}()})}()}();
//# sourceMappingURL=index.6dd2425c.js.map
